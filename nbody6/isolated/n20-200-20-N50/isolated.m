...
SetDirectory["~/git/workspace/nbody6/isolated/n20-200-20-N50/results"];
stars={1000};
...
Do[
	...
	minTime = Min[times];
	timeList = With[{t=Sort[{20,50,100,200,300,400,minTime}]},Take[t,Prepend[Flatten[Position[t,minTime]],1]]];
